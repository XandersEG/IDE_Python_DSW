...
namespace IDEPython
{
    ...
    public partial class MainView : Window
    {
        ...
        public MainView(User user, ApiService api)
        {
            this.user = user;
            this.api = api;
        ...
        private void VerTareasCurso_Click(object sender, RoutedEventArgs e) {
            ...
            if (btn != null)
            {
                ...
                if (course != null)
                {
                    AssignmentsView ventanaTareas = new AssignmentsView(course, this.user, api);
                    ventanaTareas.Show();
                    this.Close();
                }
            }
        ...
        private void AbrirProyecto_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (btn != null)
            {
                ...
                else
                {
                    ...
                    IScript templateScriptBase = new IDEPython.Utils.Decorator.Script("# New project template\nprint(\"Hello New Project\")\n", "main.py");
        ...
        private void CargarProyectos()
        {
            ...
            if (dirs.Length == 0)
            {
                ...
                IScript sampleScriptBase = new IDEPython.Utils.Decorator.Script("# New project template\nprint(\"Hello from SampleProject\")\n", "main.py");
                ScriptSigned sampleScriptSigned = new IDEPython.Utils.Decorator.ScriptSigned(sampleScriptBase);
